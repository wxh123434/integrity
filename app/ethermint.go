...
import (
	...
	integritytypes "github.com/wxh123434/integrity/x/integrity/types"
        //appparams "github.com/wxh123434/integrity/app/params"
...
func NewEthermintApp(
	...
	app.IntegrityKeeper = *integritykeeper.NewKeeper(
		appCodec,
		keys[integritytypes.StoreKey],
		keys[integritytypes.MemStoreKey],
		app.BankKeeper,
		app.MintKeeper,
	)
	integrityModule := integrity.NewAppModule(appCodec, app.IntegrityKeeper)
...
func initParamsKeeper(
	...
	paramsKeeper.Subspace(integritytypes.ModuleName)
